							...
							<div class="col-xs-12 col-lg-6">
								...
								<p class="mb-2">
									...
									<a href="https://www.microsoft.com/store/apps/9nwb1trnnksf?cid=storebadge&ocid=badge" target="_blank">
										<img src="/img/microsoft-store-badge-de.png" class="img-fluid w-25" alt="grocy-desktop im Microsoft Store">
									</a>
								</p>
								<p>
							...
							<div class="col-xs-12 col-lg-6">
								...
								<p class="mb-2">
									<a href="https://play.google.com/store/apps/details?id=org.nativescript.PantryParty" target="_blank">
										<img src="/img/play-store-badge-de.png" class="img-fluid w-25" alt="Pantry Party on Google Play">
									</a>
									<a href="https://apps.apple.com/app/pantry-party/id1510485755" target="_blank">
										<img src="/img/app-store-badge-de.png" class="img-fluid w-25" alt="Pantry Party on the App Store">
									</a>
								</p>
								<p>
							...
							<div class="col-xs-12 col-lg-6">
								...
								<p class="mb-2">
									<a href="https://play.google.com/store/apps/details?id=de.bulling.barcodebuddyscanner" target="_blank">
										<img src="/img/play-store-badge-de.png" class="img-fluid w-25" alt="Barcode Buddy on Google Play">
									</a>
								</p>
								<p>
