			...
			<div class="row align-items-center d-flex">
				...
				<div class="col-xs-12 col-lg-7">
					...
					<p class="font-weight-light font-italic grandminor-info mb-0">
						...
						Aktuell übersetzt in: Englisch, Deutsch, Dänisch, Spanisch, Französisch, Ungarisch, Italienisch, Niederländisch, Norwegisch, Polnisch, Portugiesisch (Brasilien), Russisch, Slovakisch, Schwedisch, Türkisch und Niederländisch
					</p>
				</div>
